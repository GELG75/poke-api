...
export const PokemonPage = () => {
  ...
  return (
    <div className="flex justify-center item-center flex-wrap w-full min-h-max">
      <section className="w-1/4 min-w-[350px] min-h-max flex flex-col items-center justify-center my-5">
        <img className="w-11/12 max-h-max" src={imgFront} alt={altImg} />
        <section className="flex min-w-[340px]  flex-wrap ">
