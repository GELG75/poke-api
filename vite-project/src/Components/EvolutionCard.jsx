...
export const EvolutionCard = ({pokemon}) => {
 const ENDPOINT=`https://pokeapi.co/api/v2/pokemon/${pokemon}`
  ...
  const FORMAT_CLASS=`cardPokemon transition-all  w-40 h-40 p-5 rounded-lg flex flex-col justify-around items-center ${colorBg2} shadow-md hover:opacity-80 cursor-pointer`
...
const handlerClick=(e)=>{
  ...
  return (
    <div className={FORMAT_CLASS} onClick={handlerClick}>
      ...
      <img className="w-full h-full" src={imgFront} alt={name} />
      </div>
